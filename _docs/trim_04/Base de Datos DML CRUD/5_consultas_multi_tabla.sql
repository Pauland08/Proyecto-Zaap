...
-- ===================================================================================== --
-- Ver campañas con su donacion asociada y el usuario que la gestiona
SELECT c.id_campania, c.titulo AS campania, d.titulo AS donacion, d.monto, c.estado, u.nombre_usuario
FROM Campania c
