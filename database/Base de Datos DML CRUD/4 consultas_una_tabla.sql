...
SELECT titulo, descripcion, meta FROM `Campania` WHERE estado = 'activa';

-- 8.3 Contar campañas finalizadas
SELECT COUNT(*) AS total_finalizadas FROM `Campania` WHERE estado = 'finalizada';
...
SELECT * FROM Reporte_estadistico;

-- 10.2 Ver reportes de un usuario
SELECT id_reporte, tipo_reporte, fecha_reporte FROM Reporte_estadistico WHERE id_usuario = 1;
